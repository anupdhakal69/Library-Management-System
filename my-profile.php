                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post">
                                ...
                                <button type="submit" name="delete" class="btn btn-danger" id="delete" onclick="return confirm('Are you sure you want to delete your profile? This action cannot be undone.');">Delete Profile</button>
                            </form>
                        </div>
                    </div>
                </div>
